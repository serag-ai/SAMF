...
class ModelArguments:
    ...
    model_with_lora: Optional[str] = field(
        default="./weights/outputs/model_with_lora.bin"
    )
    ...
    # vision
    vision_tower: Optional[str] = field(default="dino_large")  # None, "vit3d"
    ...
    # projector
    mm_projector_type: Optional[str] = field(default="aggregator")
    ...
    mm_fuse_type: Optional[str] = field(
        default="ao2d", metadata={"help": "[samf,ao2d,identity]"}
    )
